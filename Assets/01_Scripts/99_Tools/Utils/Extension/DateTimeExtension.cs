...
public static class DateTimeExtensions
{
    ...
    {
        var oneDecadeOlderDate = DateTime.Now.AddYears(YEARS_PER_DECADE * -1);
    ...
    {
        var oneCenturyOlderDate = DateTime.Now.AddYears(YEARS_PER_CENTURY * -1);
    ...
    {
        return date.AddMilliseconds(milliSeconds  * -1);
    }
    ...
    {
        return date.AddSeconds(seconds  * -1);
    }
    ...
    {
        return date.AddMinutes(minutes * -1);
    }
    ...
    {
        return date.AddFortnights(fortnights  * -1);
    }
    ...
    {
        return date.AddDecades(decades  * -1);
    }
    ...
    {
        return date.AddCenturies(centuries  * -1);
    }
    ...
    {
        var years = time.GetYearsSince();
        return (years / YEARS_PER_CENTURY);
    }
